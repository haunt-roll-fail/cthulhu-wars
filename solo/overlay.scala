...
object Overlays {
    ...
    def info(s : $[Any]) : |[String] = (s @@ {
        ...
        case $("Dimensional Shambler") => loyaltyCard(DimensionalShamblerCard.name, DimensionalShamblerCard.quantity, DimensionalShamblerCard.cost, DimensionalShamblerCard.combat, "Pay 2 Doom to obtain this Loyalty Card, then place 1 Dimensional Shambler onto your Faction Card.", "Walk Between Worlds", "Ongoing", "When Summoning a Dimensional Shambler, place it onto your Faction Card. After any Action (by any player), you may place one or more Dimensional Shamblers from your Faction Card into any Area. Once placed, Dimensional Shambler remain on the Map (until Killed or otherwise Eliminated).")
