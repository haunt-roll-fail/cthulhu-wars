...
object BotYS extends BotX(implicit g => new GameEvaluationYS)

class GameEvaluationYS(implicit game : Game) extends GameEvaluation(YS)(game) {
    def eval(a : Action) : $[Evaluation] = {
        ...
        def checkAttack(r : Region, f : Faction, allies : $[UnitFigure], foes : $[UnitFigure], d : Int) {
            ...
            f match {
                ...
                case BG =>
                    ...
                    val ownStr = adjustedOwnStrengthForCosmicUnity((un > 0).??(un - 1) + (by > 0).??(by + 1) + has.??(game.ritualCost), allies, foes, opponent = f)
                ...
                case SL =>
                    ...
                    val enemyStr = sm + fs * (f.count(FormlessSpawn) + f.count(Tsathoggua)) + tsa.??(max(2, power - 1)) + egug * 3 + esht * 2 + esv + eby.??(4) + eab.??(efi) + eny
        ...
        a match {
            ...
            case MoveAction(_, u, o, d, cost) if u.uclass == Acolyte =>
                ...
                unemployed && d.freeGate && d.allies.cultists.none && self.gates.num < self.allInPlay.%(_.canControlGate).num && d.capturers.none && (have(KingInYellow) || allSB) |=> 1400 -> "ic free gate"
                unemployed && d.freeGate && d.allies.cultists.none && self.gates.num < self.allInPlay.%(_.canControlGate).num && d.capturers.any && d.capturers.%(_.power > 0).none && (have(KingInYellow) || allSB) |=> 1300 -> "ic temporary free gate"
            ...
            case MoveAction(_, u, o, d, cost) if u.uclass == Byakhee =>
                ...
                power == 1 && d.desecrated && d.allies.none && o.allies.goos.none && (!o.desecrated || o.allies.num > 1) && !(o.allies.monsterly.num == 1 && o.foes.monsterly.active.any && o.allies.cultists.any) |=> 120 -> "come feast"
            ...
            case MoveAction(_, u, o, d, cost) if u.uclass == Undead =>
                ...
                power == 1 && d.desecrated && d.allies.none && (o.allies.goos.none || o.allies.num > 8) && (!o.desecrated || o.allies.num > 1) && !(o.allies.monsterly.num == 1 && o.foes.monsterly.active.any && o.allies.cultists.any) |=> 220 -> "come feast"
                o.ownGate && o.foes.monsterly.active.any && o.allies.monsterly.num == 1 && o.allies.goos.none |=> -500 -> "dont abandon gate"
                o.ownGate |=> -20 -> "leave own gate"
            ...
            case MoveAction(_, u, o, d, cost) if u.uclass == KingInYellow =>
                ...
                !have(Hastur) && (d.enemyGate || d.foes.%(_.vulnerableG).%(u => !u.faction.has(Devolve) || u.faction.pool(DeepOne).num >= u.faction.at(d).cultists.num).any) && active.%(f => f.strength(f.at(d).diff(f.at(d).cultists.take(1)), self) > d.allies.num).none && power > 2 |=> 450 -> "maybe capture"
            ...
            case ScreamingDeadAction(_, o, d) =>
                ...
                !forgetGates && d.enemyGate && d.controllers.num == 1 && d.controllers.monsterly.none && (d.foes.monsterly.num < o.allies(Undead).num || d.owner.blind(self)) && d.foes.goos.none && power > 1 |=> 1000 -> "go get a gate"
                !forgetGates && d.enemyGate && d.controllers.num == 2 && d.controllers.monsterly.none && (d.foes.monsterly.num < o.allies(Undead).num || d.owner.blind(self)) && d.foes.goos.none && power > 2 && power > d.owner.power |=> 900 -> "go get a gate"
            ...
            case SummonAction(_, Undead, r) =>
                ...
                r.controllers.num == 1 && r.allies.monsterly.none && r.foes.monsterly.any && r.foes.goos.none |=> 60 -> "prevent losing gate"
                r.controllers.num == 1 && r.controllers.%(_.capturable).any && r.foes.goos.none |=> 600 -> "prevent losing gate"
                r.controllers.num == r.allies.num && r.allies.num == 1 && r.foes.goos.active.none && r.foes.monsterly.active.any && (power < 10 || have(Hastur)) |=> 6200 -> "prevent losing gate"
                r.controllers.num == r.allies.num && r.allies.num == 2 && r.foes.goos.active.none && r.foes.monsterly.active.any && (power < 10 || have(Hastur)) |=> 5200 -> "prevent losing gate"
                r.controllers.num == r.allies.num && r.allies.num >= 3 && r.foes.goos.active.none && r.foes.monsterly.active.any && (power < 10 || have(Hastur)) |=> 4200 -> "prevent losing gate"
        ...
        if (game.battle.any) {
            if (game.battle./~(_.sides).has(self).not) {
                ...
                def elim(u : UnitFigure) {
                    ...
                    u.is(KingInYellow) && opponent.has(Harbinger) && opponent.rolls.count(Pain) + opponent.rolls.count(Kill) >= self.forces.num && opponent.power > 1 |=> 10000 -> "sacrifice kiy"
                ...
                a match {
                    ...
                    case RetreatUnitAction(_, u, r) =>
                        ...
                        u.monsterly && r.ownGate && r.foes.goos.active.none |=> 400 -> "send monster to own gate"
